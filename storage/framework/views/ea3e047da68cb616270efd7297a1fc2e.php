    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="highlight">
                ...
                • <strong>Username (JAMB Email):</strong> <?php echo e($email); ?><br>
                • <strong>Temporary Password (Phone):</strong> <?php echo e($password); ?><br><br>
            ...
            <p style="text-align: center;">
                <a href="<?php echo e(url('/login')); ?>" class="btn" style="color: #ffffff;">Log In to Student Portal</a>
            </p>
...
<?php /**PATH /home/yamojr/devyamo/SchoolofNursing/edusaas/resources/views/emails/clearance_approved.blade.php ENDPATH**/ ?>