...
import { Heart, KeyRound, User, Lock, AlertCircle, HelpCircle } from 'lucide-react'
        ...
        <div className="max-w-md w-full space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-surface-200 shadow-lg overflow-hidden">
            ...
            <div className="p-8 pb-4 text-center">
              <span className="text-xs font-bold text-teal-600 uppercase tracking-widest">Track Admission Process</span>
            ...
            <div className="mx-8 p-4 bg-teal-50 rounded-2xl border border-teal-100 flex gap-2 text-left">
              <AlertCircle className="text-teal-600 shrink-0 mt-0.5" size={16} />
              <div className="space-y-0.5">
                <span className="text-[10px] font-black text-teal-800 uppercase tracking-wider block">Credentials Help</span>
                <span className="text-[10px] text-teal-700 leading-relaxed block">
            ...
            <form onSubmit={handleSubmit} className="p-8 pt-6 space-y-5 text-left">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full rounded-xl border-surface-300 text-sm pl-9 focus:border-teal-500" 
                  />
              ...
              <button 
                type="submit"
                disabled={processing}
                className="w-full inline-flex items-center justify-center gap-2 py-3.5 rounded-xl text-white bg-teal-600 hover:bg-teal-700 font-bold text-sm shadow-md transition-colors"
              >
