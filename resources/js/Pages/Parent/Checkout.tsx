...
import { CreditCard, ArrowLeft, ShieldCheck, Calendar, Info, CheckCircle2, Users } from 'lucide-react'
...
export default function ParentCheckout({ fee, available_gateways, errors }: Props) {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    post(route('parent.fees.pay', fee.id))
  }
    ...
    <AppLayout title="Payment Checkout">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-6 flex items-center gap-4">
          <Link href={route('parent.fees')} className="p-2 rounded-full hover:bg-surface-100 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-6">
            {/* Child Selection Summary */}
            <Card padding="none" className="overflow-hidden border-brand-100">
              <div className="p-6 border-b border-surface-100 bg-brand-50/30">
              ...
              <div className="p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-surface-500">Student ID: {fee.student.admission_number}</p>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-surface-50 border border-surface-200 border-dashed">
              <p className="text-xs text-surface-500 text-center leading-relaxed">
                Paying institution fees online is safe. You will be redirected to the secure gateway of your choice.
              </p>
            </div>
          </div>
        </div>
